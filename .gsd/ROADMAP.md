...
|---|------|--------|-------------|
| 1 | Domain Models & State Machine | ⬜ PENDING | Pure domain layer: Pydantic v2 models, JobStatus enum, LEGAL_TRANSITIONS, validate_transition(), custom exceptions. No I/O, no HTTP. |
